...
start_subtask "Install aerospace"
brew install --cask nikitabobko/tap/aerospace >/dev/null 2>&1
end_subtask "Install aerospace" true

start_subtask "Group apps in dock"
defaults write com.apple.dock autohide -bool true
defaults write com.apple.dock expose-group-apps -bool true 
killall Dock
end_subtask "Group apps in dock" true

start_subtask "Displays have separate spaces"
defaults write com.apple.spaces spans-displays -bool true && killall SystemUIServer
end_subtask "Displays have separate spaces" true

start_subtask "Drag using windows ctrl+cmd"
defaults write -g NSWindowShouldDragOnGesture -bool true
end_subtask "Drag using windows ctrl+cmd" true
